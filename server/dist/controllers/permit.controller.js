import { z } from 'zod';
import { createPermitService, getPendingPermitsService, approvePermitService } from '../services/permit.service.js';
...
export const createPermitController = async (req, res) => {
    try {
...
export const getPendingPermitsController = async (req, res) => {
    try {
...
export const approvePermitController = async (req, res) => {
    try {
